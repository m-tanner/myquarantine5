...
from src.app.main.forms import EditProfileForm, EditProfileAdminForm, PostForm
from src.app.models import User, Role, Permission, Post
...
def index():
    ...
    if show_followed:
        query = current_user.followed_users
    else:
        query = User.query
    pagination = query.order_by(User.name.desc()).paginate(
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        current_user.housemates = form.housemates.data
        current_user.significant_others = form.significant_others.data
        current_user.my_five = form.my_five.data
    ...
    form.housemates.data = current_user.housemates
    form.significant_others.data = current_user.significant_others
    form.my_five.data = current_user.my_five
